...
const config: Config = {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      logo: {
        alt: 'AI Logo',
        src: 'data:image/svg+xml;base64,',
        width: 32,
        height: 32,
      },
      items: [
        ...
        },
        {
          type: 'html',
          position: 'right',
          value: '<a class="neon-button" href="/signin" style="text-decoration: none; color: white;">Sign In</a>',
        },
      ],
    },
    footer: {
